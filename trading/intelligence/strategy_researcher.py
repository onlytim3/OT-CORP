    ...
    "stat_arb": {
        ...
        "strategies": {
            ...
            "funding_arb": {
                ...
                "regime": "all",
                "data_needed": "funding rates (Bybit)",
                "complexity": "medium",
                "decay_risk": "low",
                "status": "implemented",
            },
    ...
    "carry_yield": {
        ...
        "strategies": {
            ...
            "basis_carry": {
                ...
                "status": "not_implemented",
                "priority": 8,
                "notes": "Highly profitable in bull markets — Bybit may have quarterly contracts",
            },
            "staking_yield_diff": {
    ...
    "microstructure": {
        ...
        "strategies": {
            "taker_divergence": {
                ...
                "sharpe_range": "0.3-0.8",
                "regime": "all",
                "data_needed": "taker volume (Bybit)",
                "complexity": "medium",
                "decay_risk": "medium",
                "status": "implemented",
            ...
            "microstructure_composite": {
                ...
                "sharpe_range": "0.8-2.0",
                "regime": "volatile",
                "data_needed": "liquidation feed (Bybit)",
                "complexity": "high",
                "decay_risk": "low",
                "status": "implemented",
            },
            ...
            "order_flow_imbalance": {
                ...
                "sharpe_range": "0.5-1.5",
                "regime": "all",
                "data_needed": "order book depth (Bybit)",
                "complexity": "high",
                "decay_risk": "medium",
                "status": "not_implemented",
                "priority": 8,
