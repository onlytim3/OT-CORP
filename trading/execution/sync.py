...
from trading.execution.router import get_order_status, get_positions_from_bybit
...
# ---------------------------------------------------------------------------
# 1. sync_positions — Bybit (or paper) positions  -->  local DB
# ---------------------------------------------------------------------------
...
def sync_positions() -> int:
    ...
    """
    try:
        broker_positions = get_positions_from_bybit()
